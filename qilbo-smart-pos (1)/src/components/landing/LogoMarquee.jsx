...
export default function LogoMarquee() {
  ...
  return (
    <section className="bg-secondary py-10 border-y border-border">
      <p className="text-center text-xs uppercase tracking-widest text-muted-foreground mb-6">Built for every kind of independent store</p>
      <div className="relative overflow-hidden">
        <div className="flex gap-10 animate-marquee w-max">
          {row.map((it, i) => (
            <div key={i} className="flex items-center gap-2 text-foreground/70 shrink-0">
