    ...
    <section className="relative pt-40 pb-24 md:pt-48 md:pb-32 overflow-hidden">
      ...
      <div className="relative max-w-[1240px] mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[3.4rem] leading-[1.08] font-bold tracking-tight text-stone-900">
            Stock it right. <span className="text-amber-800">Qilbo does the counting.</span>
          </h1>
          <p className="mt-6 text-lg text-stone-600 leading-relaxed max-w-[46ch]">
          ...
          <div className="mt-9 flex items-center gap-4">
            ...
            <a href="#workflow" className="inline-flex items-center text-sm font-medium text-stone-600 hover:text-stone-900 transition-colors">
              See how it works →
            </a>
          </div>
        </div>
